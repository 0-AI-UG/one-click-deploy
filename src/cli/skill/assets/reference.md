...
OCD deploys externally built, immutable OCI images. `.ocd-deploy.json`
contains complete app configuration and the initial digest; CI uses
`ocd release` for later digests.
...
- [Stacks and services](docs/stacks-and-services.md)
