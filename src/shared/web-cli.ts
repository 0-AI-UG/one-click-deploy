...
export const WEB_CLI_COMMANDS: WebCliCommand[] = [
  ...
  { id: "ops.cancel", category: "Operations", label: "Cancel operation", description: "Stop and compensate an operation safely.", args: ["ops", "cancel"], inputs: [resource("operation", "Operation", "operation", { required: true, positional: true })], danger: true, fixedArgs: ["--yes"] },
