...
export const WEB_CLI_COMMANDS: WebCliCommand[] = [
  ...
  { id: "app.delete", category: "Apps", label: "Delete app", description: "Destroy app containers and DNS; managed volumes are detached and retained.", args: ["delete"], inputs: [app()], danger: true, unavailableReason: "App deletion requires the dedicated browser approval flow. Use the dashboard controls or local CLI." },
