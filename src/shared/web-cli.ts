...
export const WEB_CLI_COMMANDS: WebCliCommand[] = [
  ...
  { id: "app.deploy", category: "Apps", label: "Deploy manifest", description: "Apply a local manifest containing an immutable image digest.", args: ["deploy"], inputs: [], unavailableReason: "Deploy reads a local manifest. Run it in a workspace containing the manifest; the panel never clones source code." },
