...
export const WEB_CLI_COMMANDS: WebCliCommand[] = [
  ...
  { id: "app.promote", category: "Apps", label: "Promote staging", description: "Promote the exact deployed source version to another app.", args: ["promote"], inputs: [{ ...app("Source app"), key: "from", label: "From", positional: false, flag: "from" }, { ...app("Destination app"), key: "to", label: "To", positional: false, flag: "to" }], danger: true, unavailableReason: "Promotion requires the dedicated browser approval flow. Use the app staging controls or local CLI." },
  { id: "app.delete", category: "Apps", label: "Delete app", description: "Destroy app containers; DNS stays operator-owned and managed volumes are detached and retained.", args: ["delete"], inputs: [app()], danger: true, unavailableReason: "App deletion requires the dedicated browser approval flow. Use the dashboard controls or local CLI." },
  { id: "app.deploy", category: "Apps", label: "Build and deploy manifest", description: "Build the exact Git commit on an OCD worker and apply complete desired state.", args: ["deploy"], inputs: [], unavailableReason: "Deploy reads a local manifest and Git checkout. Run it from the source workspace with the local CLI." },
  ...
  { id: "stacks.promote", category: "Stacks", label: "Promote stack", description: "Promote ready staging siblings in dependency order.", args: ["promote", "stack"], inputs: [stack()], danger: true, unavailableReason: "Stack promotion requires the dedicated browser approval flow. Use the stack controls or local CLI." },
  { id: "stacks.deploy", category: "Stacks", label: "Deploy stack", description: "Deploy a stack from local digest-pinned manifests.", args: ["deploy", "stack"], inputs: [], unavailableReason: "Stack deployment reads local manifests. Run it in the workspace containing those manifests." },
  ...
  { id: "services.delete", category: "Services", label: "Delete service", description: "Destroy service containers and retain its environment.", args: ["service", "delete"], inputs: [service()], danger: true, unavailableReason: "Service deletion requires the dedicated browser approval flow. Use the service controls or local CLI." },
  ...
  { id: "ops.cancel", category: "Operations", label: "Cancel operation", description: "Stop and compensate an operation safely.", args: ["ops", "cancel"], inputs: [resource("operation", "Operation", "operation", { required: true, positional: true })], danger: true, unavailableReason: "Operation cancellation requires the dedicated browser approval flow. Use the operation detail controls or local CLI." },
  ...
  { id: "servers.create", category: "Servers", label: "Provision server", description: "Provision a provider server.", args: ["servers", "create"], inputs: [resource("type", "Server type", "server-type", { required: true, flag: "type" }), resource("location", "Location", "location", { required: true, flag: "location" }), { key: "name", label: "Name", kind: "text", flag: "name" }], danger: true, unavailableReason: "Server creation requires the dedicated browser approval flow. Use Resources or the local CLI." },
  { id: "servers.delete", category: "Servers", label: "Delete server", description: "Permanently destroy an unused server.", args: ["servers", "delete"], inputs: [server()], danger: true, unavailableReason: "Server deletion requires the dedicated browser approval flow. Use Resources or the local CLI." },
