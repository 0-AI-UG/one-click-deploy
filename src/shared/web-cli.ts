...
export const WEB_CLI_COMMANDS: WebCliCommand[] = [
  ...
  { id: "buckets.list", category: "Resources", label: "List S3 buckets", description: "List buckets visible to the configured S3-compatible credential.", args: ["buckets", "list"], inputs: [{ key: "storage", label: "Storage connection", kind: "text", flag: "storage" }] },
  { id: "buckets.create", category: "Resources", label: "Create S3 bucket", description: "Create a private S3-compatible bucket.", args: ["buckets", "create"], inputs: [{ key: "bucket", label: "Bucket name", kind: "text", required: true, positional: true }, { key: "storage", label: "Storage connection", kind: "text", flag: "storage" }], danger: true },
  { id: "buckets.delete", category: "Resources", label: "Delete S3 bucket", description: "Delete an empty S3-compatible bucket. Objects are never recursively removed.", args: ["buckets", "delete"], inputs: [{ key: "bucket", label: "Bucket name", kind: "text", required: true, positional: true }, { key: "storage", label: "Storage connection", kind: "text", flag: "storage" }], danger: true },
