...
import { Server, Rocket, HardDrive, Users, LogOut, Terminal, Layers, Boxes, TerminalSquare, Check, Cpu, Menu } from "lucide-react";

const navItems = [
  { hash: "#/", label: "Dashboard", icon: Server, match: /^#\/?$/ },
  { hash: "#/deploy", label: "Deploy", icon: Rocket, match: /^#\/deploy/ },
  { hash: "#/stacks", label: "Stacks", icon: Boxes, match: /^#\/stacks/ },
